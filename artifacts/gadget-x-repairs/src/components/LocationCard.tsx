...
export function LocationCard() {
  return (
    <section id="location" className="py-16 px-4 bg-zinc-950 scroll-mt-20 border-t border-zinc-900">
      <div className="max-w-[1240px] mx-auto grid lg:grid-cols-2 gap-10">
        <div>
          <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-6 text-white">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div>
              ...
              <div className="space-y-1 max-w-xs font-bold">
                {BUSINESS.hours.map((h) => (
                  <div key={h.day} className="flex justify-between border-b border-zinc-800 pb-1">
                    <span className="uppercase text-sm">{h.day}</span>
                    <span className="text-yellow-400 text-sm">{h.time}</span>
                  </div>
                ))}
              </div>
            </div>
            <div>
              ...
              <a href={BUSINESS.phoneTel} className="flex items-center gap-2 text-white hover:text-red-500 font-bold">
        ...
        <div className="relative border-8 border-white bg-zinc-900 overflow-hidden shadow-[12px_12px_0px_0px_rgba(239,68,68,1)] min-h-[300px]">
