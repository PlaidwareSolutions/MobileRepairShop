...
export function StickyMobileBar() {
  return (
    <div
      ...
      className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-black border-t-4 border-red-500 grid grid-cols-5"
    >
      <a
        href={BUSINESS.phoneTel}
        data-testid="link-mobile-call"
        className="flex flex-col items-center justify-center gap-1 py-3 text-white font-black uppercase text-[10px] tracking-widest hover:bg-red-500 transition-colors"
      >
      ...
      <a
        ...
        className="flex flex-col items-center justify-center gap-1 py-3 text-white font-black uppercase text-[10px] tracking-widest hover:bg-red-500 transition-colors border-r-2 border-black"
      >
