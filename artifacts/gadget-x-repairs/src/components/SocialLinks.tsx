...
const PLATFORMS = [
  ...
  { key: "socialX" as const, label: "X", Icon: XIcon },
];

export function SocialLinks({ business, className = "", iconClass = "w-5 h-5" }: Props) {
  const links = PLATFORMS.filter((p) => !!business[p.key]);
